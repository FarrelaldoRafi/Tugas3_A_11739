...
st.markdown("<h1 style='text-align: center; color: #ACAF50;'>Prediksi IPK - 1739</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    # Load the model
    model_directory = r"C:\Users\Admin\Music\Semester 5\Machine Learning\Tugas3_A_11739"
